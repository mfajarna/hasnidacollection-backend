            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="border px-6 py-4">Nama Item</th>
                    ...
                    <tbody>
                        @forelse($transaction as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4 ">{{ $item->collection->name }}</td>
                                ...
                                <td class="border px-6 py- text-center">
                                    <a href="{{ route('transaction.show', $item->id) }}" class="inline-block  text-green-500 font-bold py-2 px-4 mx-2 rounded">
                                        View
                                    </a>
